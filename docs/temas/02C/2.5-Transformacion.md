...
### Transformar relación 1:1

En este caso, la clave ajena se pone en cualquier entidad y se añade como clave alternativa/única (`UK`).

![](images/04relaciones11.png "Transformación de relación 1:1"){ align="right" width="40%"}
...
![](images/04ejemplo11.png "Ejemplo de relación 1:1"){ align="right" width="30%"}
...
`**EMPLEADO** (dni, nombre, dirección)`<br>
`· PK: (dni)`<br><br>
`**VEHICULO** (matrícula, marca, modelo)`<br>
`· PK: (matrícula)`<br>
`· UK: (dniEmpleado)`<br>
...
![](images/04relacionesnm.png "Transformación de relación N:M"){ align="right" width="60%"}
...
![](images/04ejemplonm.png "Ejemplo de relación N:M"){ align="left" width="30%"}
