...
# **Modelo Físico: Lenguaje SQL (DML y DCL)**
...
!!! info "Información de la unidad"
    ...
    === "Propuesta didáctica"
          ...
          Una vez conocido el modelo relacional, en esta unidad vamos a comenzar a trabajar el RA2 "**Crea bases de datos definiendo su estructura y las características de sus elementos según el modelo relacional**",
