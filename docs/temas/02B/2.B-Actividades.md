...
??? "Ejercicio AC201.B"
    ...
    | Enunciado | Criterios de Evaluación  | Ponderación |
    | --- | --- | --- |
    | Analiza la siguiente tabla EMPLEADO y enumera todos los errores que encuentres. A continuación, aporta una solución para cada uno de ellos. Finalmente, analiza las claves existentes: | RABD.6 // CE6b, CE6c // | 3p |
...
??? "Ejercicio AC205.B"
    ...
    Utiliza [https://erdplus.com/](https://erdplus.com/) o [https://dbdiagram.io/](https://dbdiagram.io/) para crearlo.
...
??? "Ejercicio AC311.B"
    ...
    A partir del esquema y de las tablas obtenidas en la actividad [AC205.B](#ac205b), completa el diccionario de datos, indicando tanto la información de las tablas, como sus relaciones y restricciones.
